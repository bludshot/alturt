...
static menucommon_s *g_movement_controls[] =
{
	...
	(menucommon_s *)&s_controls.walkforward,
	 (menucommon_s *)&s_controls.sprint,
...
static void Controls_UpdateModel( int anim ) {
	...
	case ANIM_WEAPON3:
		s_controls.playerWeapon = WP_SPAS;
		break;

	case ANIM_WEAPON4:
		s_controls.playerWeapon = WP_HK69;
		break;

	case ANIM_WEAPON5:
		s_controls.playerWeapon = WP_UMP45;
		break;

	case ANIM_WEAPON6:
		s_controls.playerWeapon = WP_LR300;
		break;

	case ANIM_WEAPON7:
		s_controls.playerWeapon = WP_PSG1;
		break;

	case ANIM_WEAPON8:
		s_controls.playerWeapon = WP_AK103;
		break;
...
static void Controls_MenuInit( void )
{
	...
	s_controls.sprint.generic.type	     = MTYPE_ACTION;
	s_controls.sprint.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.sprint.generic.callback  = Controls_ActionEvent;
	s_controls.sprint.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.sprint.generic.id        = ID_SPRINT;
