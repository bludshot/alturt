...
struct gclient_s {
	...
	int			inactivityTime;		// kick players when time > this
                  qboolean                                        loadoutEnabled;
                  qboolean                                        modeChanged;
	int			modechangeTime;
...
gentity_t *fire_grenade (gentity_t *self, vec3_t start, vec3_t aimdir, int mode);
...
void G_BreakGlass( gentity_t *ent, vec3_t point ); //Xamis
#ifdef MISSIONPACK
