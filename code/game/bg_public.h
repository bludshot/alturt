...
#define MINS_Z                          -27
#define DEFAULT_VIEWHEIGHT      35 //blud, was 26
#define CROUCH_VIEWHEIGHT       17 //blud, was 12
#define DEAD_VIEWHEIGHT         -16
#define PLAYER_STANDHEIGHT		42 //blud new constant
#define PLAYER_CROUCHHEIGHT		21 //blud new constant
...
typedef enum {
    ...
    WEAPON_START_BANDAGING_OTHER,
    WEAPON_DOWN_BANDAGING,
     WEAPON_DOWN_BANDAGING_OTHER,
