...
float   pm_ladderscale = 0.50; //Xamis
...
PM_LadderMove()         --needs a lot of work--
			...
			going down ladder is ok,
			go up with forward/Jump, go down with crouch /back
			Currently getting on ladder from top does't work correctly, too easy to fall off of ledge!
===================
*/
...
static void PM_LadderMove( void ) {
	...
	if ( !scale ) { 
		...
		wishvel[1] = 0;//scale * pml.forward[1]*pm->cmd.forwardmove; // +
